    ...
    <>
            ...
            <div className="row">
              <div className="col-md-5">
                <div className="img-topp position-relative">
                  ...
                  <Link to="/product" className="shoppingButton1">
                    КУПИТЬ СЕЙЧАС→
                  </Link>
                </div>
              ...
              <div className="col-md-7 right-big position-relative">
                ...
                <Link to="/product" className="shoppingButton2">
                  КУПИТЬ СЕЙЧАС→
                </Link>
              </div>
            </div>
      ...
      <div className="Product">
        <div className="container">
          <div className="row d-flex justify-content-end my-5 text-center">
            <div
              className="col-md-1 col-xs-2 yanam"
              onClick={() => Filter("Мебель")}
            >
              <p>Мебель</p>
            </div>
            <div
              className="col-md-1 col-xs-2 yanam"
              onClick={() => Filter("Светильники")}
            >
              <p>Светильники</p>
            </div>
            <div
              className="col-md-1 col-xs-2 yanam "
              onClick={() => Filter("Декор")}
            >
              <p>Декор</p>
            </div>
          </div>
      ...
      >
        <div className="col-md-6 px-5 py-4 teps">
          ...
          <Link to="/product" className="shoppingButton3">
            КУПИТЬ СЕЙЧАС→
          </Link>
        </div>
        <div className="col-md-6 px-5 py-4 text-center">
          <div className="left-big-text2">
            <div className="redi">
              <h3 className="one-text">ЭКСКЛЮЗИВНЫЙ КУБОК</h3>
              <br />
              <span>ВПЛОТЬ ДО</span>
